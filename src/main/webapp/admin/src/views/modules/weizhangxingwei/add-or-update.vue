<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="违章行为" prop="weizhangxingwei">
          <el-input v-model="ruleForm.weizhangxingwei" 
              placeholder="违章行为" clearable  :readonly="ro.weizhangxingwei"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `weizhangxingwei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weizhangxingweiCrossAddOrUpdateFlag = false;
                  this.parent.search();
