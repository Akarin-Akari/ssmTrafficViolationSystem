<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车牌种类" prop="chepaizhonglei">
          <el-input v-model="ruleForm.chepaizhonglei" 
              placeholder="车牌种类" clearable  :readonly="ro.chepaizhonglei"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chepaizhonglei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chepaizhongleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
