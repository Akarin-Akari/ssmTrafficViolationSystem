<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行政区划" prop="xingzhengquhua">
          <el-input v-model="ruleForm.xingzhengquhua" 
              placeholder="行政区划" clearable  :readonly="ro.xingzhengquhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行政区划" prop="xingzhengquhua">
              <el-input v-model="ruleForm.xingzhengquhua" 
                placeholder="行政区划" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xingzhengquhua'){
            this.ruleForm.xingzhengquhua = obj[o];
	    this.ro.xingzhengquhua = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xingzhengquhua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xingzhengquhuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
