<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行驶方向" prop="xingshifangxiang">
          <el-input v-model="ruleForm.xingshifangxiang" 
              placeholder="行驶方向" clearable  :readonly="ro.xingshifangxiang"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xingshifangxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xingshifangxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
